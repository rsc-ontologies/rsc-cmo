...
$(IMPORTDIR)/ms_import.owl: mirror/ms.owl $(IMPORTDIR)/ms_terms.txt
...
$(IMPORTDIR)/chebi_import.owl: mirror/chebi.owl $(IMPORTDIR)/chebi_terms.txt
...
$(IMPORTDIR)/obi_import.owl: mirror/obi.owl $(IMPORTDIR)/obi_terms.txt
	if [ $(IMP) = true ]; then $(ROBOT) query -i $< --update ../sparql/preprocess-module.ru \
